      ...
      <div className="relative flex items-center justify-center w-[840px] h-[300px] overflow-hidden">
        ...
        >
          <div
            ...
            className="w-[430px] h-[240px] relative group overflow-hidden cursor-pointer shadow-lg rounded-2xl mx-2 md:mx-3"
            style={{
              transform: "scale(0.8)",
              zIndex: 1,
            }}
          ...
          >
            <div className="h-[260px] transition-all duration-300 group-hover:scale-105">
              <img
                width={1000}
                height={1000}
            ...
            <div className="absolute bottom-14 flex w-full z-10">
              <div className="relative max-w-[80%] mx-auto text-left text-white">
                <h1 className="pb-8 text-2xl font-bold transition-all duration-300 group-hover:text-[26px]" style={{ textShadow: "2px 2px 4px rgba(0, 0, 0, 0.7)" }}>
        ...
        >
          ...
          >
            <div className=" h-[640px] lg:h-[260px] transition-all duration-300 group-hover:scale-105">
              <img
                width={1000}
                height={1000}
            ...
            <div className="absolute bottom-14 flex w-full z-10">
              <div className="relative max-w-[80%] mx-auto text-left text-white">
                ...
                <small className="absolute w-full text-xxs bottom-[38px] transform -translate-y-1/2 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300 text-yellow-500 text-sm">
                  Voir les offres
                </small>

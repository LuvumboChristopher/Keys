        ...
        <motion.div className="w-full mx-auto z-10 flex justify-center items-center">
            <motion.div className="w-full mx-auto flex flex-col items-start justify-start gap-6">
                {[TfiBolt, TfiLightBulb, TfiIdBadge].map((Icon, index) => (
                    <motion.div
                        key={index}
                        className={`w-full mx-auto border-l-[10px] border-yellow-500 p-7 lg:p-6 cursor-pointer transition-all duration-300 rounded-md ${isLargeScreen ? "bg-gray-50 bg-opacity-10 text-white" : "bg-white text-black"}`}
                    ...
                    >
                        <div className="w-full max-w-[95%] mx-auto lg:py-2">
                            ...
                            <p className="text-[10px] lg:text-[11px]">
                                {[
                                    "Obtenez instantanément les infos essentielles du poste.",

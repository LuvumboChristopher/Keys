...
import { FaBuilding, FaMapMarkerAlt, FaClock, FaRegSadCry, FaKey, FaHeart, FaRegHeart, FaPlus, FaDollarSign, FaEuroSign } from "react-icons/fa";
    ...
    return (
        <section id="dernieres-offres-emploi" className="bg-gray-100 border-t-[1px] border-b-[1px] border-gray-300">
            <div className="container py-10 md:py-12">
                ...
                <div className="grid gap-12 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 md:py-2">
                        ...
                        >
                            <div>
                                ...
                                <div className="job-card-content relative z-10 text-black">
                                    ...
                                    <div className="flex flex-col xs:flex-row sm:flex-col md:flex-row rounded-xl overflow-hidden my-7 ">
                                        <div className="w-full space-y-3  text-md p-4">
                                            <motion.div
                                            ...
                                            >
                                                <div className="p-3 bg-green-200 rounded-2xl border ">
                                                    <FaMapMarkerAlt className="text-lg text-green-600" />
                                                </div>
                                                <p className="ml-3 text-xs md:text-md text-gray-700 capitalize truncate whitespace-nowrap">{job.town_name}</p>
                                            </motion.div>
                                            <motion.div
                                                className="flex items-center "
                                                initial={{ opacity: 0 }}
                                            ...
                                            >
                                                <div className="p-3 bg-yellow-200 rounded-2xl border ">
                                                    <FaClock className="text-lg text-yellow-600" />
                                                </div>
                                                <p className="ml-3 text-xs md:text-md text-gray-700 capitalize truncate whitespace-nowrap">{job.contract_type}</p>
                                            </motion.div>
                                            <motion.div
                                                className="flex items-center "
                                                initial={{ opacity: 0 }}
                                                ...
                                                transition={{ duration: 0.3, delay: 0.8 }}
                                            >
                                                <div className="p-3 bg-orange-200 rounded-2xl border ">
                                                    <FaEuroSign className="text-lg text-yellow-600" />
                                                </div>
                                                <p className="ml-3 text-xs md:text-md text-gray-700 capitalize truncate whitespace-nowrap">                                                {job.hourly_rate} €<small className="text-xxs xs:text-xs">/ heure</small>                                                </p>
                                            </motion.div>
                                        </div>
                                    </div>
                                    <motion.div

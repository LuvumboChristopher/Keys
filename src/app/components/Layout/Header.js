...
>
        ...
        <div
          className={`container mx-auto flex justify-between items-center relative h-[110px]  md:h-[130px] duration-30`}
        >
          <motion.div>
            <Link href="/">
              <Image
              ...
              <Image
                ...
                height={2000}
                loading="lazy"
                className={`hidden dark:block transition-opacity ease-in-out w-[95px]  sm:w-[105px] md:w-[115px] ${scrolled || !isHomePage ? "opacity-100" : "opacity-0"
                  }`}
              />
            </Link>
          </motion.div>

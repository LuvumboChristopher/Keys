    ...
    return (
        <motion.div initial={{ opacity: 0 }}
            ...
            <motion.div
                ...
                className={` w-full md:w-[111vw] lg:w-full xl:w-[53vw] 2xl:w-full md:min-h-[90px]  bg-gray-50 border-b md:border-b-0  md:border-r  p-6 w-full flex items-center justify-center flex-row gap-5 overflow-hidden `}
            > 
                <div
            ...
            <motion.ul
                ...
                className={`px-6 w-full flex flex-col justify-items-center justify-center space-y-2 text-xs p-6`}
            >

...
const JobFilters = ({ filters, handleFilterChange, handleResetFilters, sectors }) => {
    return (
        <>
            <h2 className="text-xl font-bold my-2 border-b pb-6">Filtres</h2>
            <div className="filters">
                <div className="filter my-6 border-b pb-6 ">
                    ...
                    <input
                        ...
                        className="p-4 border w-full rounded-3xl focus:outline-none focus-within:border-gray-400 "
                ...
                <button
                    ...
                    className="w-full bg-yellow-500 text-white py-4 px-4 hover:bg-black transition duration-400 rounded-3xl overflow-hidden"
                >
                    Réinitialiser
                </button>
            </div>

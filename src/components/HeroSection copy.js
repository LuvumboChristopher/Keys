...
const HeroSection = () => {
    ...
    return (
        <>
            <section
                className="bg-cover bg-bottom bg-no-repeat flex flex-col items-center justify-center pt-36 pb-16 md:pt-32 md:pb-24 lg:pt-54 lg:pb-38 relative z-10 "
            ...
            >
                <div className="w-full max-w-md md:max-w-3xl lg:max-w-4xl xl:max-w-5xl mx-auto ">
                    ...
                    {/* Logo y llave */}
                    <motion.div
                        className="relative w-full text-center flex flex-col items-center pb-8 md:pb-6"
                        initial={{ opacity: 0, y: -30 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 1 }}
                    >
                        <motion.div className="absolute flex items-center justify-center top-14">
                            <FaKey className="text-yellow-500 text-6xl md:text-7xl lg:text-8xl" />
                        </motion.div>
                        <motion.img
                            loading="lazy"
                            alt="Keys"
                            src="/images/keyslogos/Keys-logo-black-yellow.svg"
                            className="w-[220px] md:w-66 lg:w-[280px]"
                        />
                    </motion.div>
                    ...
                    <div className="w-full mx-auto px-4">
                        ...
                        >
                            ...
                            {/* Botón de enviar */}
                            <button className=" w-full bg-yellow-500 text-white font-semibold px-6 p-4 rounded-2xl hover:bg-black hober:text-white transition duration-300 shadow-lg">
                                C'est partie !
                            </button>
                        </motion.div>
                    </div>

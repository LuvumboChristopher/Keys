...
export const SearchComponentBlack = ({ scrolled, showBar, location, setLocation }) => {
    return (
        ...
        >
            ...
            >
                <div className="container flex flex-col lg:flex-row items-center bg-black duration-300 cursor-pointer">
                    <div className="w-full lg:w-3/5 border-b lg:border-none mb-8 lg:mb-0 flex items-center">
                        ...
                        <input
                            ...
                            className="w-full px-3 py-5 text-white bg-black focus:outline-none"
                        />
                    </div>
                    <div className="bg-white h-8 w-px mx-4"></div>
                    <div className="w-full lg:w-3/5 border-b lg:border-none mb-8 lg:mb-0 flex items-center">
                        <TfiLocationArrow className="text-xl text-white" />
                        <input
                            className="w-full px-3 py-5 text-white bg-black focus:outline-none"
                    ...
                    <button className="w-auto block mx-auto flex items-center justify-center bg-yellow-500 hover:text-black px-5 py-5 font-semibold hover:bg-white text-white lg:border-r lg:border-l border-black transition-all duration-500">

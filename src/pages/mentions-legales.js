            ...
            <main className="py-6 md:py-12 dark:bg-gray-900  bg-gray-100 text-left text-xs sm:text-sm lg:text-md ">
                <div className="container bg-white shadow-md rounded-2xl p-8">
                    ...
                    <section className="space-y-3">
                        <h2 className="text-lg lg:text-xl font-semibold mb-6">Informatiques & libertés</h2>
                        <p className="mb-4">
                    ...
                    <section className="space-y-3 mt-6">
                        <h2 className="text-lg lg:text-xl font-semibold mb-6">Propriétés intellectuelles</h2>
                        <p className="mb-4">
                    ...
                    <section className="space-y-3 mt-6">
                        <h2 className="text-lg lg:text-xl font-semibold mb-6">Limitation de responsabilité</h2>
                        <p className="mb-4">
                    ...
                    <section className="space-y-3 mt-6">
                        <h2 className="text-lg lg:text-xl font-semibold mb-6">Données à caractère personnel</h2>
                        <p className="mb-4">
                    ...
                    <section className="space-y-3 mt-6">
                        <h2 className="text-lg lg:text-xl font-semibold mb-6">Éditeur du site</h2>
                        <p className="mb-4">
                            <strong>KEYS - INTERIM & RECRUTEMENT</strong><br />
                            29 RUE CDT FAURAX 69006 LYON<br />
